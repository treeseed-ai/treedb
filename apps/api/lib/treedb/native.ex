defmodule TreeDb.Native do
  ...
  def put_federation_peer(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def list_federation_peers(_data_dir), do: :erlang.nif_error(:nif_not_loaded)
  def get_federation_peer(_data_dir, _node_id), do: :erlang.nif_error(:nif_not_loaded)
  def put_repository_advertisement(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def list_repository_advertisements(_data_dir), do: :erlang.nif_error(:nif_not_loaded)
  def put_federation_route(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def list_federation_routes(_data_dir), do: :erlang.nif_error(:nif_not_loaded)
  def get_federation_route(_data_dir, _repo_id), do: :erlang.nif_error(:nif_not_loaded)
  def put_node_capacity(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def list_node_capacity(_data_dir), do: :erlang.nif_error(:nif_not_loaded)
  def put_mirror_assignment(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def list_mirror_assignments(_data_dir, _repo_id), do: :erlang.nif_error(:nif_not_loaded)
  def put_workspace_route(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def get_workspace_route(_data_dir, _workspace_id), do: :erlang.nif_error(:nif_not_loaded)
  def put_idempotency_record(_data_dir, _input), do: :erlang.nif_error(:nif_not_loaded)
  def get_idempotency_record(_data_dir, _id), do: :erlang.nif_error(:nif_not_loaded)
