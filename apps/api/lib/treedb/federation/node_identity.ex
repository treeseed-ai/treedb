defmodule TreeDb.Federation.NodeIdentity do
  @moduledoc false

  @private_prefix "treedb-ecdsa-p256-private:"
  @public_prefix "treedb-ecdsa-p256-public:"

  def node_id,
    do:
      System.get_env("TREEDB_FEDERATION_NODE_ID") || System.get_env("TREEDB_NODE_ID") ||
        "node_local"

  def base_url do
    System.get_env("TREEDB_FEDERATION_NODE_BASE_URL") ||
  ...
  def ensure_keys! do
    ...
    unless File.exists?(public_path) do
      raise "missing TreeDB federation public key at #{public_path}"
    end
  ...
  defp private_key_path do
    System.get_env("TREEDB_FEDERATION_NODE_PRIVATE_KEY_PATH") ||
      Path.join([TreeDb.Store.data_dir(), "keys", "node-private.pem"])
  end

  defp public_key_path do
    System.get_env("TREEDB_FEDERATION_NODE_PUBLIC_KEY_PATH") ||
      Path.join([TreeDb.Store.data_dir(), "keys", "node-public.pem"])
  end
end
