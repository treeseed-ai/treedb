defmodule TreeDb.Exec.WorkerProtocol do
  @moduledoc false
  ...
  def headers(body) do
    ...
    headers =
      case System.get_env("TREEDB_EXEC_WORKER_TOKEN") do
    ...
    case System.get_env("TREEDB_EXEC_WORKER_HMAC_SECRET") do
      secret when is_binary(secret) and secret != "" ->
        signature = :crypto.mac(:hmac, :sha256, secret, body) |> Base.encode16(case: :lower)
        [{"x-treedb-worker-signature", "sha256=#{signature}"} | headers]
