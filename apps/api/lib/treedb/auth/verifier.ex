defmodule TreeDb.Auth.Verifier do
  @moduledoc false

  @verifiers %{
    "hs256_dev" => TreeDb.Auth.Verifiers.Hs256Dev,
    "jwks_oidc" => TreeDb.Auth.Verifiers.JwksOidc,
    "trusted_internal" => nil
  }

  def type do
    System.get_env("TREEDB_AUTH_VERIFIER") || legacy_default()
  end
  ...
  defp validate_runtime_safety do
    if type() == "hs256_dev" && prod_runtime?() &&
         System.get_env("TREEDB_ALLOW_DEV_VERIFIER_IN_PROD") != "true" do
      {:error,
       %{
  ...
  defp legacy_default do
    if System.get_env("TREEDB_JWT_HS256_SECRET"), do: "hs256_dev", else: nil
  end
end
