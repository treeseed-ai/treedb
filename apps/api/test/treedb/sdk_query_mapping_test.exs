defmodule TreeDb.SdkQueryMappingTest do
  use ExUnit.Case, async: true

  alias TreeDb.RepositoryQuery.{Filters, Sort}

  test "SDK-style content entries can be assembled from generic TreeDB documents" do
    document = %{
  ...
  test "SDK filter and sort specs map to generic TreeDB document fields" do
    docs = [
      %{
        "path" => "b.md",
