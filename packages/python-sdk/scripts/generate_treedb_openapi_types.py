...
OUTPUT_PATH = PACKAGE_ROOT / "src" / "treedb_sdk" / "generated" / "openapi_types.py"
...
def render_openapi_types() -> str:
    ...
    return (
        "# Generated by scripts/generate_treedb_openapi_types.py. Do not edit by hand.\n\n"
        "from typing import Final, Literal, TypedDict\n\n\n"
        "TreeDbOpenApiMethod = Literal[\"GET\", \"POST\", \"PUT\", \"PATCH\", \"DELETE\"]\n\n\n"
        "class TreeDbOpenApiOperation(TypedDict):\n"
        "    method: TreeDbOpenApiMethod\n"
        "    path: str\n\n\n"
        f"TREE_DB_OPENAPI_OPERATION_COUNT: Final[int] = {len(operations)}\n\n"
        "TREE_DB_OPENAPI_OPERATIONS: Final[tuple[TreeDbOpenApiOperation, ...]] = (\n"
