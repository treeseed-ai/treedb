...
import { TreeDbClient, TreeDbConformanceAdapter, type TreeDbConformanceScenario } from '../../src/treedb/index.js';
import { MockTransport } from '../adapters/mock.js';

function loadScenarios(): TreeDbConformanceScenario[] {
...
describe('TreeDbConformanceAdapter', () => {
  ...
  it('reports not_configured without a server', async () => {
    ...
    const adapter = new TreeDbConformanceAdapter({ client });
