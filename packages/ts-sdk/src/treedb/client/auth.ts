import type { AuthProvider, TreeDbClientConfig } from '../types/index.js';
...
export async function resolveAuthorizationHeader(config: Pick<TreeDbClientConfig, 'token' | 'authProvider'>): Promise<Record<string, string>> {
