...
| `npm test` | fail | Missing fixture submodule plus package graph assertion. |
...
2. Decide whether the package graph test should ignore its own forbidden-string assertions or rewrite the test fixture text.
3. Add an explicit `typecheck` script if TypeScript checking should be part of the SDK baseline.
