defmodule TreeDbProfiler.SchedulerRaceTest do
  use ExUnit.Case
  ...
  test "does not apply file write effect for unverified accepted race status" do
    fixture =
      Fixtures.generate!("small-docs",
        ...
        repo_prefix: "profile-",
        fixture_root: Path.join(System.tmp_dir!(), "treedb-profiler-test"),
        size: "small",
        seed: "scheduler-race"
      )
      |> then(fn fixture ->
  ...
  after
    File.rm_rf(Path.join(System.tmp_dir!(), "treedb-profiler-test"))
  end
end
