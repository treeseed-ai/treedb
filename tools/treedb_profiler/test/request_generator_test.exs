defmodule TreeDbProfiler.RequestGeneratorTest do
  use ExUnit.Case, async: true

  alias TreeDbProfiler.{Fixtures, PortfolioState, RequestGenerator}

  setup do
    root =
      Path.join(
        System.tmp_dir!(),
        "treedb-profiler-generator-#{System.unique_integer([:positive])}"
      )
