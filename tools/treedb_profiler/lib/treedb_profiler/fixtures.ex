defmodule TreeDbProfiler.Fixtures do
  @moduledoc false

  alias TreeDbProfiler.GitFixture
  ...
  defp generate_one!(fixture_id, opts) when fixture_id in @canonical do
    ...
    expected = TreeDbProfiler.Expectations.from_fixture(defn, repos)
  ...
  defp merge_fixtures(fixture_id, opts, fixtures) do
    ...
    %{
      ...
      expected: TreeDbProfiler.Expectations.from_fixture(defn, local_repos),
      definition: defn,
