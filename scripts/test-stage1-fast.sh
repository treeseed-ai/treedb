...
(
  ...
  mix test \
    test/treedb/auth_test.exs \
    test/treedb/auth_verifier_test.exs \
    test/treedb/jwks_cache_test.exs \
    test/treedb_web/auth_controller_test.exs \
    test/treedb_web/auth_policy_controller_test.exs \
...
(
  ...
  npx vitest run --config ./vitest.config.ts \
    ...
    test/utils/treedb-public-hygiene.test.ts
)
