...
(
  ...
  mix test \
    test/treedb_web/graph_controller_test.exs \
    test/treedb_web/context_controller_test.exs \
    test/treedb_web/graph_incremental_refresh_test.exs \
    test/treedb_web/search_index_controller_test.exs \
    test/treedb_web/context_modes_test.exs \
...
(
  ...
  npx vitest run --config ./vitest.config.ts \
    test/utils/treedb-graph-parity.test.ts \
    test/utils/treedb-search-index.test.ts \
    test/utils/treedb-context-modes.test.ts \
